...
#include "my_slam_liosam/save_map.h"
...
public:
    ...
    */
    mapOptimization()
    {
        ...
        subCloud = nh.subscribe<my_slam_liosam::cloud_info>("lio_sam/feature/cloud_info", 1, &mapOptimization::laserCloudInfoHandler, this, ros::TransportHints().tcpNoDelay());
        // 订阅GPS里程计
    ...
    */
     ...
     * 保存全局关键帧特征点集合
    */
    bool saveMapService(my_slam_liosam::save_mapRequest& req, my_slam_liosam::save_mapResponse& res)
    {
    ...
    */
    void visualizeGlobalMapThread()
    {
        ...
        my_slam_liosam::save_mapRequest  req;
        my_slam_liosam::save_mapResponse res;
